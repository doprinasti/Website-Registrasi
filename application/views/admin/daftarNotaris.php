<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        ...
        <div class="navbar-form navbar-right">
            <?php echo form_open('admin/daftarNotaris') ?>
    ...
    <a class=" btn btn-sm btn-primary mb-2 shadow" href="<?php echo base_url('admin/DaftarNotaris/tambahData/') ?>">
            ...
            <tbody>
                ...
                foreach ($notaris as $n) : ?>
                    <tr>
                        ...
                        <td>
                            <center>
                                <a class="btn btn-sm btn-warning ml-auto" href="<?php echo base_url('admin/daftarNotaris/editData/' . $n->id) ?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a onclick="return confirm('Anda Yakin untuk Menghapus Data?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/daftarNotaris/hapusData/' . $n->id) ?>">
