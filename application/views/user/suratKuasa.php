<div class="container-fluid">
    ...
    <a class=" btn btn-sm btn-primary mb-2 shadow" href="<?php echo base_url('user/SuratKuasa/tambahData/') ?>">
            ...
            <tbody>
                ...
                foreach ($surku as $s) : ?>
                    <tr>
                        ...
                        <td>
                            <center>
                                <a class="btn btn-sm btn-warning mb-2" href="<?php echo base_url('user/suratKuasa/editData/' . $s->idsu) ?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a onclick="return confirm('Anda Yakin untuk Menghapus Data?')" class="btn btn-sm btn-danger" href="<?php echo base_url('user/suratKuasa/hapusData/' . $s->idsu) ?>">
