<div class="container-fluid">
    ...
    <a class=" btn btn-sm btn-primary mb-2" href="<?php echo base_url('user/pendafCVPT') ?>">
        <i class="fas fa-arrow-left mr-1"></i>Kembali
    </a>

    <div class="card" style="width:50%">
        <div class="card-body">
            <?php echo form_open_multipart('user/pendafCVPT/tambahDataAksi'); ?>
            <div class="form-group">
                <label>Jenis Badan Usaha</label>
                <input type="hidden" name="id_pt" class="form-control">
                <input type="jenisbu" name="noreg" class="form-control">
