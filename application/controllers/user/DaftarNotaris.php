...
class DaftarNotaris extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = 'http://localhost/PNregistrasi/user/DaftarNotaris/index';
        ...
        $this->load->view('user/DaftarNotaris', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templates_user/header', $data);
        $this->load->view('templates_user/sidebar');
        $this->load->view('user/tambahDaftarNotaris', $data);
        $this->load->view('templates_user/footer');
    }
    ...
    public function editData($id)
    {
        ...
        $this->load->view('templates_user/header', $data);
        $this->load->view('templates_user/sidebar');
        $this->load->view('user/editDaftarNotaris', $data);
        $this->load->view('templates_user/footer');
    }
