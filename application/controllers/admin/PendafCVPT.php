...
class PendafCVPT extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = 'http://localhost/PNregistrasi/admin/pendafCVPT/index';
        ...
        $this->load->view('admin/pendafCVPT', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templates_admin/header', $data);
        $this->load->view('templates_admin/sidebar');
        $this->load->view('admin/tambahPendafCVPT', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function editData($id)
    {
        ...
        $this->load->view('templates_admin/header', $data);
        $this->load->view('templates_admin/sidebar');
        $this->load->view('admin/editPendafCVPT', $data);
        $this->load->view('templates_admin/footer');
    }
