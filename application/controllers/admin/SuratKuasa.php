...
class SuratKuasa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = 'http://localhost/PNregistrasi/admin/suratKuasa/index';
        ...
        $this->load->view('admin/suratKuasa', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templates_admin/header', $data);
        $this->load->view('templates_admin/sidebar');
        $this->load->view('admin/tambahSurKu', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function editData($id)
    {
        ...
        $this->load->view('templates_admin/header', $data);
        $this->load->view('templates_admin/sidebar');
        $this->load->view('admin/editSurKu', $data);
        $this->load->view('templates_admin/footer');
    }
